...
class ViecoiscraperPipeline:
    def process_item(self, item, spider):
        ...
        time_update_str = adapter.get('time_update')
        if time_update_str:
        ...
        if time_expire:
            # Cộng số ngày vào time_update
            adapter['time_expire'] = datetime.strptime(time_update_str, "%d/%m/%Y")
